...
// Treatment effectiveness scoring algorithm
...
function checkDrugInteractions(primaryDrug, otherDrugs = []) {
  const interactions = drugInteractions[primaryDrug.toLowerCase()] || { major_interactions: [], moderate_interactions: [], contraindications: [] };
